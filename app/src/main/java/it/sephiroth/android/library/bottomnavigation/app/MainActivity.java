...
@TargetApi(Build.VERSION_CODES.KITKAT_WATCH) public class MainActivity extends BaseActivity
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    log(TAG, VERBOSE, "translucentStatus: %b", hasTranslucentStatusBar());
    ...
    if (hasTranslucentStatusBar()) {
      ViewCompat.setOnApplyWindowInsetsListener(toolbar, new OnApplyWindowInsetsListener() {
        @Override public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
          toolbar.setPadding(toolbar.getPaddingLeft(), insets.getSystemWindowInsetTop(),
        ...
        ViewCompat.setOnApplyWindowInsetsListener(viewPager, new OnApplyWindowInsetsListener() {
          ...
          public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
            viewPager.setPadding(viewPager.getPaddingLeft(), viewPager.getPaddingTop(),
                ...
                viewPager.getPaddingBottom() + insets.getSystemWindowInsetBottom());
            return insets;
          }
        });
      }
      getBottomNavigation().setOnMenuChangedListener(new BottomNavigation.OnMenuChangedListener() {
        @Override public void onMenuChanged(final BottomNavigation parent) {
  ...
  @Override public void onMenuItemReselect(@IdRes final int itemId, final int position,
    ...
    if (fromUser) {
      ...
      MainActivityFragment fragment =
          (MainActivityFragment) manager.findFragmentById(R.id.fragment);
      if (null != fragment) {
